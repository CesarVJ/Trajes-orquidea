                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn-cancelar"
                                        href="../cancelarPedido.php?id=<?php echo $listaCompras->getId_compra();?>" style="color:#fff;text-decoration:none;"><button type="button" class="btn btn-danger">Cancelar pedido</button></a>
                            </div>
                        </div>
                    </div>
                </div>
